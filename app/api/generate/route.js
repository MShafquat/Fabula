...
export async function POST(req) {
    ...
    Generate exactly 6 exercises: 1 comprehension (multiple choice about the story), 1 fill_in_blank, 1 vocabulary (multiple choice definitions), 1 word_match (with exactly 4 word-translation pairs from the vocabulary), 1 word_scramble (scramble a vocabulary word's letters), and 1 sentence_order (use a short sentence of 4-7 words from the story, split into individual words). Make sure the word_scramble scrambled field is a proper anagram of the answer field.`;
        ...
        try {
            const imageStyles = {
                'Beginner': `A beautiful storybook illustration depicting "${result.title}" with a ${topic} theme. The art style mimics soft hand-drawn lines with warm pastel tones and gentle shading, like a classic illustrated children's book. Charming characters, inviting composition, clean graceful outlines. Do NOT depict any drawing tools, pencils, or art supplies in the scene. NO text, NO words, NO letters anywhere in the image.`,
                'Intermediate': `A richly detailed book illustration depicting "${result.title}" with a ${topic} theme. The art style has expressive hand-drawn linework with layered color washes, warm lighting, and atmospheric depth, like illustrations in a quality illustrated novel. Do NOT depict any drawing tools, pencils, or art supplies in the scene. NO text, NO words, NO letters anywhere in the image.`,
                'Advanced': `A sophisticated and cinematic book illustration depicting "${result.title}" with a ${topic} theme. The art style features masterful rendering with rich tonal depth, subtle color gradients, intricate environmental details, and dramatic atmospheric lighting, like a premium illustrated literary edition. Do NOT depict any drawing tools, pencils, or art supplies in the scene. NO text, NO words, NO letters anywhere in the image.`,
            };
